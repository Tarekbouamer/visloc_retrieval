...
# Image Retrieval
from image_retrieval.tools import make_sat_dataloader, make_model, make_optimizer
...
def main(args):
    ...
    # Load data
    train_dataloader, val_dataloader = make_sat_dataloader(args, config, rank, world_size,
                                                       log_debug=log_debug,
                                                       log_info=log_info)
