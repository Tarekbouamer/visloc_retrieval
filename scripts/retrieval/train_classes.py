...
from image_retrieval.datasets.clusters          import ISSDataset, ISSTransform, INPUTS
from image_retrieval.datasets.misc              import iss_collate_fn
from image_retrieval.datasets.generic.generic   import ImagesFromList, ImagesTransform
...
def make_dataloader(args, config, rank=None, world_size=None):
    ...
    # Training dataloader
    train_db = ISSDataset(  root_dir=args.data,
                            name=data_config.get("training_dataset"),
                            mode='train',
                            transform=train_tf)
    ...
    val_db = ISSDataset(root_dir=args.data,
                           name=data_config.get("training_dataset"),
                           mode='val',
                           transform=val_tf)
