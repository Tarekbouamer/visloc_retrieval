...
def sfm_mobilenetv3_large_100_gem(cfg=None, pretrained=True, **kwargs):
    ...
    return _create_retrieval('sfm_mobilenetv3_large_100_gem', 'mobilenetv3_large_100', 'gem', cfg, pretrained, **model_args)
...
def sfm_tf_efficientnet_l2_ns_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_tf_efficientnet_l2_ns_gem', 'tf_efficientnet_l2_ns', 'gem', cfg, pretrained, **model_args)
...
def sfm_regnetz_d8_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_regnetz_d8_gem', 'regnetz_d8', 'gem', cfg, pretrained, **model_args)
...
def sfm_resnet200d_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_resnet200d_gem', 'resnet200d', 'gem', cfg, pretrained, **model_args)
...
def sfm_tf_efficientnet_b7_ns_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_tf_efficientnet_b7_ns_gem', 'tf_efficientnet_b7_ns', 'gem', cfg, pretrained, **model_args)
...
def sfm_tf_efficientnet_b7_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_tf_efficientnet_b7_gem', 'tf_efficientnet_b7', 'gem', cfg, pretrained, **model_args)
...
def sfm_tf_efficientnet_b5_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_tf_efficientnet_b5_gem', 'tf_efficientnet_b5', 'gem', cfg, pretrained, **model_args)
...
def sfm_tf_efficientnet_b6_ns_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_tf_efficientnet_b6_ns_gem', 'tf_efficientnet_b6_ns', 'gem', cfg, pretrained, **model_args)
...
def sfm_regnety_160_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_regnety_160_gem', 'regnety_160', 'gem', cfg, pretrained, **model_args)
...
def sfm_regnety_120_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_regnety_120_gem', 'regnety_120', 'gem', cfg, pretrained, **model_args)
...
def sfm_ig_resnext101_32x8d_gem(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_ig_resnext101_32x8d_gem', 'ig_resnext101_32x8d', 'gem', cfg, pretrained, **model_args)
...
def sfm_resnet18_gem_512(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_resnet18_gem_512', 'resnet18', 'gem', cfg, pretrained, **model_args)
...
def sfm_resnet50_gem_2048(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_resnet50_gem_2048', 'resnet50', 'gem', cfg, pretrained, **model_args)
...
def sfm_resnet50_c4_gem_1024(cfg=None, pretrained=True, feature_scales=[1, 2, 3], **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_resnet50_c4_gem_1024', 'resnet50', 'gem', cfg, pretrained, feature_scales, **model_args)
...
def sfm_resnet101_gem_2048(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_resnet101_gem_2048', 'resnet101', 'gem', cfg, pretrained, **model_args)
...
def sfm_resnet101_c4_gem_1024(cfg=None, pretrained=True, feature_scales=[1, 2, 3], **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('sfm_resnet101_c4_gem_1024', 'resnet101', 'gem', cfg, pretrained, feature_scales, **model_args)
...
def gl18_resnet50_gem_2048(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('gl18_resnet50_gem_2048', 'resnet50', 'gem', cfg, pretrained, **model_args)
...
def gl20_resnet50_gem_2048(cfg=None, pretrained=True, **kwargs):
    ...
    """
    model_args = dict(**kwargs)
    return _create_retrieval('gl20_resnet50_gem_2048', 'resnet50', 'gem', cfg, pretrained, **model_args)


if __name__ == '__main__':
    create_fn = create_retrieval(
        "resnet50_c4_gem_1024", pretrained=True, p=1.234)
    print(create_fn)
